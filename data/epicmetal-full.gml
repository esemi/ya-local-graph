graph [
    ...
    node [
        id 2009859
        label "Only Fate Remains"
        color "red"
    ]
    node [
        id 961556
        label "Reactive Black"
        color "red"
    ]
    node [
        id 294367
    ...
    node [
        id 2746912
        label "Jimi Mitchell's Dark Fantasy"
        color "red"
    ]
    node [
        id 2038817
    ...
    node [
        id 2096172
        label "Boguslaw Balcerak's Crylord"
        color "red"
    ]
    node [
        id 1238417
